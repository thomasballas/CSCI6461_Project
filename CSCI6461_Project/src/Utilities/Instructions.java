        ...
        switch (Opcode) {
            ...
            case 49: //instruction for IN
                ...
                if (ioDevID == 0) {
                    ...
                    int num = (int) GUI.getConsoleInput().charAt(0);
                    if (GUI.getConsoleInput().length() > 1) {
                        GUI.setConsoleInput(GUI.getConsoleInput().substring(1));
                    } else {
                        GUI.setConsoleInput("");
                    }
                    if ((num < 0) || (num > 65535)) {
...
//                    GUI.updatePrinter(Integer.toString(reg.getGPR(ioR)) + " ");
                    GUI.updatePrinter((char) (reg.getGPR(ioR)) + "");
                }
                break;
            //IO instruction block
            ...
            case 40://instruction for LDFR
                ...
                if (EA != -1 && EA <= 2048 && (R == 0 || R == 1)) {
                    reg.setMAR(EA);
                    reg.setMBR(mem.getMem(reg.getMAR()));
                    reg.setFR(R, DataTypeConvertor.intToFloat(reg.getMBR()));
//                    reg.setFR(1, DataTypeConvertor.intToFloat(reg.getMBR() + 1));
                } else {
                    System.out.println("error");
                }
                break;
            ...
            case 41://instruction for STFR
                ...
                if (EA != -1 && EA <= 2048 && (R == 0 || R == 1)) {
                    reg.setMAR(EA);
                    mem.setMem(reg.getMAR(), DataTypeConvertor.FloatToIntRep(reg.getFR(R)));
//                    mem.setMem(reg.getMAR() + 1, DataTypeConvertor.FloatToIntRep(reg.getFR(1)));
                } else {
                    System.out.println("error");
                }
                break;
